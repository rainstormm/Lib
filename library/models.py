...
class Book(models.Model):
    ...
    description = models.CharField(
        max_length=1024, default="", verbose_name="Description"
    )
    price = models.CharField(max_length=20, null=True, verbose_name="Price")

    category = models.CharField(
        max_length=64, default=u"Literature", verbose_name="Category"
    )
    cover = models.ImageField(
        blank=True, null=True, upload_to=custom_path, verbose_name="Cover"
    )
    index = models.CharField(max_length=16, null=True, verbose_name="Index")
    location = models.CharField(
        max_length=64, default=u"first floor", verbose_name="Location"
    )
